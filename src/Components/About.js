        ...
        <Row>
          <Col>
            ...
            <p className="under-title under-title-loc text-white">I'm a Front-End Web Developer with a background in 3D design, 
              in addition to technical support for computers software and hardware.<br/><br/>
              ...
              <br/>
              <br/>
              I'm pasitionate about about coding and bringing creatiave solutions through code, <br/> As challenging as it could be, I love the learning challenge!   
            </p>
          </Col>
        </Row>
